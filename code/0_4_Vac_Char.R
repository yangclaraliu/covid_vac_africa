...
data.table(ve_i_o = c(0.7, 0.85),
  ...
  mutate(ve_h_condition = 1 - (1-ve_h)/((1-ve_i_o) * (1-ve_d)),
         ve_icu_condition = 1 - (1-ve_icu)/((1-ve_i_o) * (1-ve_d)),
         ve_mort_condition = 1 - (1-ve_mort)/((1-ve_i_o) * (1-ve_d))) -> ve_pfizer
...
data.table(ve_i_o = c(0.7, 0.75),
  ...
  mutate(ve_h_condition = 1 - (1-ve_h)/((1-ve_i_o) * (1-ve_d)),
         ve_icu_condition = 1 - (1-ve_icu)/((1-ve_i_o) * (1-ve_d)),
         ve_mort_condition = 1 - (1-ve_mort)/((1-ve_i_o) * (1-ve_d))) -> ve_az
